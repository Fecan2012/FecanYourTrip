...
<body>
	<nav class="navbar navbar-default navbar-static-top no-margin"
		role="navigation" id="fetop">
		<div class="container-fluid">
			<div class="navbar-header ">
				<button type="button" class="navbar-toggle collapsed"
					data-toggle="collapse" data-target="#bs-LG-navbar-collapse-1"
					aria-expanded="false">
				...
				<div class="page-header no-margin no-padding">
					<a class="navbar-brand" href="afterlogin.do"><img
	...
	<div class="row">
		<div class="col-xs-6 col-md-6">
			<a href="detail.do?imgPath=image/hanliver.jpg&tab=top#toppoint" class="thumbnail" style="border: 0px solid;">
				<img src="image/hanliver.jpg" alt="han">
			</a> <a href="detail.do?imgPath=image/palace.jpg&tab=top#toppoint" class="thumbnail" style="border: 0px solid;"> <img
				src="image/palace.jpg" alt="pal">
			</a>
		</div>
		<div class="col-xs-6 col-md-6">
			<a href="detail.do?imgPath=image/newyork.jpg&tab=top#toppoint" class="thumbnail" style="border: 0px solid;"> <img
				src="image/newyork.jpg" alt="new">
			</a> <a href="detail.do?imgPath=image/london.jpg&tab=top#toppoint" class="thumbnail" style="border: 0px solid;"> <img
				src="image/london.jpg" alt="london">
			</a>
		</div>
	</div>
